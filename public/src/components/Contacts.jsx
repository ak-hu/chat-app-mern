...
function Contacts({ fetchAgain, selectedChat }) {
  ...
  return (
    <>
      <Container >
        <div className={`${modalActive === 'not' ? '' : 'modal-active'}`}>
          <div>
...
//                 >
//                   <div className="avatar">
//                     <img src={process.env.REACT_APP_PROFILE_PICS_PATHS+contact.profilePic} alt="" />
//                   </div>
...
//                       <div>
//                         <b>{contact.latestMessage.sender.name} : </b>
//                         {contact.latestMessage.content.length > 50
//                           ? contact.latestMessage.content.substring(0, 51) + "..."
...
//             <div className="avatar">
//               <img src={process.env.REACT_APP_PROFILE_PICS_PATHS+currentUserImage} alt="" />
//             </div>
//             <div className="username">
